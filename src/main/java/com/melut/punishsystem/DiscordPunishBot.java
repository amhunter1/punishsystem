...
public class DiscordPunishBot extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getLogger().info(getConfigManager().getString("messages.log.plugin-enabled"));
        getLogger().info(getConfigManager().getString("messages.log.bot-connecting"));
    }
    ...
    public void onDisable() {
        ...
        getLogger().info(getConfigManager().getString("messages.log.plugin-disabled"));
    }
