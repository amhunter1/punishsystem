...
public class Punishment {
    ...
    public String getTypeDisplay() {
        String typeKey = "messages.punishment-types." + type.toLowerCase();
        String defaultKey = "messages.punishment-types.default";
        String display = plugin.getConfigManager().getString(typeKey);
        return display != null ? display : plugin.getConfigManager().getString(defaultKey, type);
    }

    @Override
    public String toString() {
        return plugin.getConfigManager().getString("messages.punishment-to-string")
